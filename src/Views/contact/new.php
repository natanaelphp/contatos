        ...
        <div class="container">
            ...
            <form action="" method="POST">
                ...
                <div class="field">
                    ...
                    <input class="input" type="adress" name="adress" value="<?=old('adress')?>">
                </div>
                ...
                <br>
                <div class="field">
                    <input type="submit" value="Create contact" class="button is-success is-fullwidth">
                </div>
